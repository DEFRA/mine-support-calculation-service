...
const messageSender = new MessageSender('calculation-service-sender', config.paymentQueueConfig)
const messageReceiver = new MessageReceiver('calculation-service-receiver', config.calculationQueueConfig)
